...
<div id="addCategoryModal" class=" bg-white m-auto  items-center w-[70%] justify-center ">
    <div class="bg-white border border-gray-300     rounded-xl shadow-2xl  ">
        <h2 class="text-2xl font-semibold text-gray-800 mb-6 border-b pb-2">Add slide</h2>
        @if ($errors->any())
        ...
        <form action="{{ route('admin.slide.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Od</label>
             <input type="number" name="od" id="od"  required
                    class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm sm:text-sm focus:ring-blue-500 focus:border-blue-500">
            </div>
